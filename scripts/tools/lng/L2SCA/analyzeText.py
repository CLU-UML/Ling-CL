...
pre_path = 'scripts/tools/lng/L2SCA/'

#location of the Stanford parser
parserPath= os.path.join(pre_path, "stanford-parser-full-2020-11-17/lexparser.sh")
...
#query the parse trees using the tregex patterns
    for pattern in patternlist:
        command = pre_path + "tregex.sh " + pattern + " " + parsedFile + " -C -o"
